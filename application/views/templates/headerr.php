...
<div class="row justify-content-center">
  <div class="col-xl-11 d-flex align-items-center">
    <h1 class="logo mr-auto"><img width="30px" height="30px" src="<?=base_url('assets/');?>img/apple-touch-icon.jpeg"><a href="index.html"> Psikotes-Box</a></h1>
    ...
    <nav class="nav-menu d-none d-lg-block">
      <ul>
        ...
        <li class="drop-down"><a href="<?= base_url('auth'); ?>"><?= $user['name']; ?></a>
          <ul>
